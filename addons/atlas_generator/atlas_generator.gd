...
const ATLAS_BASE_PATH: = "res://images/atlas/"
const ATLAS_NAME_PREFIX: = "bilibiliacgn_"
const ATLAS_NAMES: = [
	"relic_atlas", 
	"relic_outline_atlas", 
	"power_atlas", 
...
func _generate_atlas(atlas_name: String) -> void :
	var stem: = ATLAS_NAME_PREFIX + atlas_name
	var tpsheet_path: = ATLAS_BASE_PATH + stem + ".tpsheet"
	var sprites_dir: = ATLAS_BASE_PATH + stem + ".sprites"
