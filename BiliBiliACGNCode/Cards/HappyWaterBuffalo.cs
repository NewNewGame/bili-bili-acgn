...
public sealed class HappyWaterBuffalo : CardBaseModel
{
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        await PowerCmd.Apply<AngerPower>(choiceContext, base.Owner.Creature, -base.DynamicVars["AngerCost"].BaseValue, base.Owner.Creature, this);
        // 获得[gold]受到的伤害减半[/gold]Buff
        await PowerCmd.Apply<HappyWaterCowPower>(choiceContext, base.Owner.Creature, 1, base.Owner.Creature, this);
    }
