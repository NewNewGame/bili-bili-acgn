...
{
    #region 卡牌关键词与悬停
    protected override IEnumerable<IHoverTip> ExtraHoverTips => [HoverTipFactory.FromKeyword(CustomKeyWords.Anger),HoverTipFactory.FromPower<TangShiPower>()];
    #endregion
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        await PowerCmd.Apply<GetTangPower>(cardPlay.Target, ((CalculatedVar)base.DynamicVars["CalculatedValue"]).Calculate(cardPlay.Target), base.Owner.Creature, null);
    }
