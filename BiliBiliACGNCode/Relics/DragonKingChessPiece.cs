//****************** 代码文件申明 ***********************
//* 文件：DragonKingChessPiece(龙王的棋子)
//* 作者：wheat
//* 创建时间：2026/04/27 17:32:00 星期一
//* 描述：拾起时，选择一张能力牌，为它添加启动。
//*******************************************************
...
public sealed class DragonKingChessPiece : RelicBaseModel
{
    ...
    public override async Task AfterObtained()
    {
		...
		foreach (CardModel item in await CardSelectCmd.FromDeckGeneric(base.Owner, prefs, (CardModel c) => c.Type == CardType.Power && c.Enchantment == null))
		{
